...
const Tab = ({className, tableId, tableSelection, includeOverlap, zIndex, text, color, editMode, handleChangeCB, handleTabSelectCB, handleColorSelectCB, handleTableDeleteCB}) => {
    ...
    const handleTableDelete = (e) => {
        handleTableDeleteCB(tableId, text);
    }
